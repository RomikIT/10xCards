...
- [x] 4.1 Type checking passes — 7b596c4
- [x] 4.2 Build succeeds — 7b596c4

#### Manual

- [x] 4.3 Review page shows question, hides answer until revealed, shows all 4 rating buttons after reveal — 7b596c4
- [x] 4.4 Grading each rating advances the queue without a full page reload — 7b596c4
- [x] 4.5 Grading the last card shows the empty-queue state with a working link back to /flashcards — 7b596c4
- [x] 4.6 Visiting the review page with zero due cards shows the empty-queue state immediately — 7b596c4
- [x] 4.7 Unauthenticated access to /flashcards/review redirects to /auth/signin — 7b596c4
